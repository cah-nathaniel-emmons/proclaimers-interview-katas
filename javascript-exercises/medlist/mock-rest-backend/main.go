...
func main() {
	...
	medications = append(medications, Medication{ID: uuid.NewV4().String(), Name: "CLOPIDOGREL TAB 75MG", Condition: "Cancer", DirectionsForUse: "Take one table 4 times a day", Prescriber: &Prescriber{ID: uuid.NewV4().String(), Name: "John Smith"}})
